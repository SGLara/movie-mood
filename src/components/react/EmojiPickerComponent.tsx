...
import { category, emojiMode, mood } from '@/store/emojiStore'
  ...
  return (
    <div className='flex flex-col justify-between items-center h-full w-full'>
      <div className='flex flex-row justify-between items-center gap-5 h-full w-full px-5'>
        <div
          className='flex flex-col justify-between items-center bg-slate-400 rounded-lg p-5 h-28 w-44'
        ...
        <div className='flex flex-col justify-center items-center p-5 bg-slate-400 rounded-lg h-auto'>
      ...
      ($mood.length === MAX_MOOD_EMOJI_SELECTED && $category.length > 0) &&
        <a
          href='/suggestions'
          className='flex justify-between gap-2 bg-orange-400 px-5 py-2 rounded-lg text-white hover:bg-orange-500 active:bg-orange-700'
        >
